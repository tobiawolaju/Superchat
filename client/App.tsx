  ...
  return (
    <div className="flex h-[100dvh] w-full bg-white overflow-hidden text-slate-900 animate-in fade-in duration-500">
      ...
      <main className="flex-1 flex flex-col relative bg-white min-w-0 overflow-hidden">
        ...
        <header className={`h-16 flex items-center justify-between px-6 bg-white border-b border-slate-50 fixed top-0 left-0 right-0 lg:left-auto lg:relative z-20 shrink-0 ${view === 'HOME' && 'lg:hidden'}`}>
        ...
        <div className="flex-1 overflow-hidden relative pt-16 lg:pt-0">
          {view === 'HOME' && (
